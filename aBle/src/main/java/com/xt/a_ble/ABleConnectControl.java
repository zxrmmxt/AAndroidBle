...
public class ABleConnectControl {
    private static final String TAG = ABleConnectControl.class.getSimpleName();
    ...
    public ABleConnectControl() {
    }

    ABleConnectControl(BluetoothDevice bluetoothDevice) {
    ...
    private void doBleCallbackAndUpdateIsFinished(boolean connectFinished) {
        ...
        for (ABluetoothGattCallback item : mABluetoothGattCallbacks) {
...
//                    setConnectFinished(true);
    ...
    private List<ABluetoothGattCallback> mABluetoothGattCallbacks = new ArrayList<>();

    void addBleGattCallback(ABluetoothGattCallback bluetoothGattCallback) {
        if (!mABluetoothGattCallbacks.contains(bluetoothGattCallback)) {
            mABluetoothGattCallbacks.add(bluetoothGattCallback);
        }
    }

    void removeBleGattCallback(ABluetoothGattCallback bluetoothGattCallback) {
        mABluetoothGattCallbacks.remove(bluetoothGattCallback);
    }
