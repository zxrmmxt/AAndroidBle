...
public class MyFastBleManager {
    ...
    public MyFastBleManager(Context context) {
        mContext = context;
    ...
    public void addMyLeScanCallback(MyLeScanCallback myLeScanCallback) {
        mScanControl.addMyLeScanCallback(myLeScanCallback);
    }

    public void removeMyLeScanCallback(MyLeScanCallback myLeScanCallback) {
        mScanControl.removeMyLeScanCallback(myLeScanCallback);
    }
    /*************************scan**********************************/
