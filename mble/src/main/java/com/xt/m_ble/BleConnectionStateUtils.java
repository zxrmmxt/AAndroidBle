...
public class BleConnectionStateUtils {
    ...
    public static int getConnectState(MyFastBleManager myFastBleManager, BluetoothDevice bluetoothDevice) {
        BluetoothManager bluetoothManager = myFastBleManager.getBluetoothManager();
    ...
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR2)
    public static String getConnectStateStr(MyFastBleManager myFastBleManager, BluetoothDevice bluetoothDevice) {
        int connectState = getConnectState(myFastBleManager, bluetoothDevice);
