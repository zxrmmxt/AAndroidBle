...
public class MyBleScanRuleConfig {
    ...
    public static class Builder {
        ...
        void applyConfig(MyBleScanRuleConfig config) {
        ...
        public MyBleScanRuleConfig build() {
            MyBleScanRuleConfig config = new MyBleScanRuleConfig();
            applyConfig(config);
            return config;
        }
